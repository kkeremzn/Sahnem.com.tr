...
namespace Sahnem.Business.Email
{
    ...
    {
        // Önceden bu logo data: URI (base64 gömülü) olarak <img src>'e veriliyordu —
        // Gmail başta olmak üzere çoğu büyük e-posta istemcisi, anti-spam/anti-
        // tracking önlemi olarak data: URI görsellerini render etmiyor/kaldırıyor,
        // bu yüzden logo gelen kutusunda boş/bozuk bir kutu olarak görünüyordu.
        // Gerçek, herkese açık bir https:// URL'e (favicon ile aynı görsel,
        // frontend'in public/ klasöründen Vercel tarafından servis ediliyor)
        // geçildi — e-posta istemcileri bunu normal bir dış görsel gibi çekip
        // gösterebiliyor.
        private const string LogoUrl = "https://sahnem.com.tr/favicon-192x192.png";
...
<tr><td class=""pad"" bgcolor=""#111017"" style=""padding:28px 40px""><table role=""presentation"" width=""100%""><tr><td><img src=""{LogoUrl}"" width=""30"" height=""30"" alt="""" style=""vertical-align:middle;border:0""> <span style=""font-size:22px;font-weight:bold;letter-spacing:2px;color:#f6f2ff;vertical-align:middle"">SAHNEM</span></td><td align=""right"" style=""font-size:10px;letter-spacing:1.5px;color:#c7a9de"">SAHNE SENİN.</td></tr></table></td></tr>
